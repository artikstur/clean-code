...
public class ValidateAuthorOrEditorFilter : IAsyncResourceFilter
{
    ...
    public ValidateAuthorOrEditorFilter(IDocumentsAccessService documentsAccessService)
    {
    ...
    public async Task OnResourceExecutionAsync(ResourceExecutingContext context, ResourceExecutionDelegate next)
    {
        ...
        try
        {
            ...
            context.Result = new BadRequestObjectResult(new { Error = "You are not author or editor" });
        }
        catch
        {
            context.Result = new UnauthorizedResult();
